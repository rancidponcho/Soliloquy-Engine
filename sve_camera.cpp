...
void SveCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
    ...
    // my implementation <BROKE>
    // viewMatrix[2] = glm::vec4(glm::normalize(direction), 0.f);
    // viewMatrix[0] = glm::vec4(glm::normalize(glm::cross(glm::vec3(viewMatrix[2]), glm::normalize(up - glm::dot(up, glm::vec3(viewMatrix[2])) * glm::vec3(viewMatrix[2])))), 0.f);
